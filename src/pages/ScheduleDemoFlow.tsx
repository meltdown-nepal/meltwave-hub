...
export default function ScheduleDemoFlow() {
  ...
  const onSubmit = async (data: DemoFormData) => {
    try {
      ...
      const response = await fetch("https://isqyxkfodhgxzcyplbkg.supabase.co/functions/v1/demo-notification", {
        method: "POST",
        headers: {
  ...
  return <div className="relative min-h-screen bg-gradient-to-b from-gray-50 to-white py-12 px-4 sm:px-6 lg:px-8">
      {/* Background image with overlay */}
      <div className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat opacity-10" style={{
