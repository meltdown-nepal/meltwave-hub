...
const Contact = () => {
  ...
  usePreloadAssets({
    "/lovable-uploads/Veda.png": {
      critical: true,
      as: 'image'
    },
    "/lovable-uploads/Karobar.png": {
      critical: true,
      as: 'image'
    },
    "/lovable-uploads/naamche.png": {
      critical: true,
      as: 'image'
    },
    "/lovable-uploads/SecurityPal.png": {
      critical: true,
      as: 'image'
    },
    "/lovable-uploads/HimalayanJava.png": {
      critical: true,
      as: 'image'
    },
    "/lovable-uploads/flextecs.png": {
      critical: true,
      as: 'image'
    },
    "/lovable-uploads/GolchhaGroup.png": {
      critical: true,
      as: 'image'
    },
    "/lovable-uploads/YoungInnovations.png": {
      critical: true,
      as: 'image'
    }
  });
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="space-y-1">
                      <a href="tel:+9779709119637" className="text-gray-600 hover:text-secondary block">+977 9709119637</a>
                      <a href="tel:+9779820115144" className="text-gray-600 hover:text-secondary block">+977 9820115144</a>
                    </div>
                  </div>
                </div>
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                {clientLogos.map((logo, index) => <div key={`${logo.id}-${index}`} className="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                    <img src={logo.src} alt={logo.alt} className="h-12 w-full object-contain" draggable={false} loading={index < 8 ? "eager" : "lazy"} decoding="async" width="150" height="48" />
                  </div>)}
              </div>
            </div>
          </div>
