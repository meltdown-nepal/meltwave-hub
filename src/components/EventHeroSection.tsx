...
import { Dumbbell, HeartPulse, Running, Timer } from "lucide-react";
...
const fitnessIcons = [
  ...
  { Icon: Running, className: "left-1/2 bottom-6 animate-[float3_5s_ease-in-out_infinite] hidden sm:block" },
];
