      ...
      <div className="container-custom">
        ...
        align: "start"
          ...
          <CarouselContent className="pl-0 md:pl-4">
            {shuffledImages.map(img => <CarouselItem key={img.src} className="basis-11/12 md:basis-1/4 px-2">
                <div className="rounded-lg overflow-hidden hover-scale shadow-lg transition-all duration-300 group cursor-pointer aspect-[3/4] bg-gray-100 flex items-center justify-center">
                  <OptimizedImage src={img.src} alt={img.alt} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" width={450} height={600} />
                </div>
              </CarouselItem>)}
          </CarouselContent>
