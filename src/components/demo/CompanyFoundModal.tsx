  ...
  return <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 text-center">
          ...
          {(company.contact_person || company.industry) && <div className="bg-gray-50 rounded-lg p-4 text-left">
              <h4 className="font-medium text-gray-800 mb-3">Company Information:</h4>
              <div className="space-y-2 text-sm text-gray-600">
                {company.contact_person && <div className="flex items-center space-x-2">
          ...
          <Button onClick={handleClose} className="w-full bg-primary hover:bg-primary/90 text-black">
            Got it, thanks!
          </Button>
        </div>
      </DialogContent>
