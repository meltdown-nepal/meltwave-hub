...
const steps = [{
  number: 1,
  title: "Apply",
  description: "Submit your application with details about your wellness services, credentials, and experience. Our team will review your application and contact you for the next steps."
}, {
  number: 2,
  title: "Onboard",
  description: "Complete our onboarding process with profile setup, service definition, and training. You'll also get access to our Academy for certification."
}, {
  number: 3,
  title: "Connect",
  description: "Receive bookings from corporate clients matched to your services, and deliver outstanding wellness programs with our support."
}];
const HowItWorksStepper = () => {
  return <section aria-labelledby="how-it-works-heading" className="w-full max-w-3xl mx-auto px-2 md:px-0 py-[50px] bg-transparent">
      ...
      <ol className="relative border-l-2 border-primary/20 mt-6 md:mt-10 space-y-8">
        {steps.map((step, idx) => <li key={step.number} className="relative ml-6 group animate-fade-in" style={{
        ...
        animationFillMode: "both"
            ...
            {idx < steps.length - 1 && <span className="absolute left-0 top-12 w-1 h-full bg-primary/10" aria-hidden="true" style={{
          zIndex: 0
        }}></span>}
          </li>)}
      </ol>
