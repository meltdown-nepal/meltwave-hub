            ...
            >
              ...
              `}>
                ...
                <div className="bg-white rounded-[2rem] overflow-hidden aspect-[9/19.5] relative">
                  {/* Status Bar */}
                  <div className="absolute top-0 left-0 right-0 h-8 bg-black rounded-t-[2rem] flex items-center justify-center">
                ...
                {/* Phone Button */}
                <div className="absolute bottom-1 left-1/2 transform -translate-x-1/2 w-12 h-12 bg-gray-800 rounded-full"></div>
              </div>
