...
export const jobListings: Job[] = [
  ...
  },
  {
    ...
    description: "About Meltdown Wellbeing\nMeltdown is a corporate wellbeing tech ecosystem designed for companies who want to not just offer wellness benefits but build a culture of active living. Unlike typical gym subsidies or one-off wellness sessions - which most employees don't use - Meltdown combines access to wellness services across Nepal with gamified challenges, social experiences, and behavior tracking that drive participation and build team connection.\n\nRole Description\nThis is a full-time, on-site role for a Sales Associate, based in Kathmandu. The Sales Associate will assist in generating leads, conducting outreach, supporting client meetings, and maintaining CRM records. The ideal candidate is enthusiastic, motivated, and eager to learn and grow in the sales field, with a passion for health, fitness, and corporate wellness.\nYou'll work closely with the sales and marketing team to support overall business development efforts and play a key role in expanding Meltdown's reach across companies.\nPosition: Junior Level",
    requirements: [
