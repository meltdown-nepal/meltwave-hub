...
export const jobListings: Job[] = [
  ...
  },
  {
    ...
    summary: "Drive corporate client acquisition, renewals, and upsells, ensuring that Meltdown's wellbeing ecosystem reaches more workplaces and stays deeply embedded in existing ones.",
    description: "Meltdown is a corporate wellbeing tech ecosystem built for companies that want to create a culture of active living — not just offer wellness benefits. Unlike typical gym subsidies or one-off wellness sessions that go unused, Meltdown combines access to wellness services across Nepal with gamified challenges, social experiences, and behavior tracking that drive participation, engagement, and team connection.\n\nThis is a full-time on-site role for a Business Development Lead, based in Kathmandu.\n\nThe Business Development Lead will be responsible for driving corporate client acquisition, renewals, and upsells, ensuring that Meltdown's wellbeing ecosystem reaches more workplaces and stays deeply embedded in existing ones.\n\nThe role combines strategic sales execution, relationship management, and data-driven performance tracking. You'll collaborate closely with marketing, operations, and product teams to meet key OKRs — focusing on new client acquisition, retention, and sustainable growth.\n\nPosition Level: Mid-Level\nReports to: Sales & Marketing Manager",
    requirements: [
      "2–4 years of proven B2B sales experience, ideally in tech, HR, or wellness sectors",
      "Strong record of meeting and exceeding sales targets",
      "Excellent communication, negotiation, and account management skills",
      "Demonstrated ability to build long-term client relationships and manage renewals",
      "Bachelor's degree in Business, Marketing, or a related field (Master's preferred)",
      "Comfortable using CRM tools, sales dashboards, and digital communication platforms"
    ],
    responsibilities: [
      "Identify, target, and convert potential corporate clients through outreach, referrals, and partnerships",
      "Build and maintain a healthy pipeline of qualified leads using CRM tools and data insights",
      "Achieve consistent client acquisition and conversion results through strong relationship-building and tailored solutions",
      "Conduct impactful sales presentations, demos, and negotiations aligned with client needs and budgets",
      "Represent Meltdown at industry events, HR forums, and wellness expos to nurture leads and partnerships",
      "Maintain strong post-sales relationships to ensure client satisfaction, renewals, and long-term retention",
      "Identify and execute upsell opportunities for events, workshops, and platform upgrades with existing clients",
      "Develop and manage a client referral system to generate warm leads from satisfied customers",
      "Collaborate with the marketing team to refine campaigns that attract and convert high-quality leads",
      "Work closely with product and operations to ensure a seamless client onboarding and experience",
      "Prepare accurate forecasts and performance reports aligned with company OKRs",
      "Mentor junior sales associates, fostering a culture of performance, accountability, and growth",
      "Collect and present client success stories that highlight measurable impact and engagement"
    ],
    location: "Kathmandu, Nepal",
    applyEmail: "meltdownnepal@gmail.com",
    benefits: [
      "Competitive salary with performance-based incentives",
      "Opportunity to be part of a fast-growing tech + wellbeing sector",
      "High visibility role with potential for leadership growth",
      "5-day work week (Monday–Friday)",
      "Exclusive access to Meltdown's wellbeing services and events"
    ],
